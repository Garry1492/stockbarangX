...
<body>
<div class="container">
    <h2 class="mt-2 mb-3">Data Retur Pembelian</h2>
    <div class="data-tables datatable-dark">
        <table class="table table-bordered" id="exportreturbeli" width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Nama Barang</th>
    ...
    <a href="returbeli.php" class="text-decoration-none">Back to Data Retur Pembelian</a>
    </div>
</div>
	
<script>
$(document).ready(function() {
    $('#exportreturbeli').DataTable( {
        dom: 'Bfrtip',
        buttons: [
            'csv','excel', 'pdf', 'print'
        ]
